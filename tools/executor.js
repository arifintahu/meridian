...
const toolMap = {
  ...
  update_config: ({ changes, reason = "" }) => {
    ...
    const CONFIG_MAP = {
      ...
      rebalanceOnUpsideBreakEnabled: ["management", "rebalanceOnUpsideBreakEnabled"],
      rebalanceMaxCount: ["management", "rebalanceMaxCount"],
      rebalanceHarvestTriggerPct: ["management", "rebalanceHarvestTriggerPct"],
      rebalanceHarvestBps: ["management", "rebalanceHarvestBps"],
